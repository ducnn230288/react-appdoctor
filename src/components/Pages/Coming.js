          ...
          <div id="wrapper">
            ...
            <div id="watch">
              <div className="dash days_dash">
                ...
                <span className="dash_title">{intl.formatMessage(messages.days)}</span>
              </div>
              <div className="dash hours_dash">
                <div className="digit">{hours}</div>
                <span className="dash_title">{intl.formatMessage(messages.hours)}</span>
              </div>
              <div className="dash minutes_dash">
                <div className="digit">{minutes}</div>
                <span className="dash_title">{intl.formatMessage(messages.minutes)}</span>
              </div>
              <div className="dash seconds_dash">
                <div className="digit">{seconds}</div>
                <span className="dash_title">{intl.formatMessage(messages.seconds)}</span>
              </div>
            </div>
          </div>
        </Content>
